...
router.post('/',uploadFile.single('image'),productsController.store);// GUARDAR NUEVO PRODUCTO


/*** EDIT ONE PRODUCT ***/
router.get('/edit/:id', productsController.edit);//VISTA DE FORMULARIO DE EDICION
router.put('/:id',uploadFile.single('image'), productsController.update);//GUARDAR DATOS ACTUALIZADOS
